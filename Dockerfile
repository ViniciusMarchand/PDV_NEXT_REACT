...
ARG NEXT_PUBLIC_PIX_NAME
ARG NEXT_PUBLIC_PIX_CITY
ARG NEXT_PUBLIC_PIX_TRANSACTION_ID
...
ENV NEXT_PUBLIC_PIX_NAME=${NEXT_PUBLIC_PIX_NAME}
ENV NEXT_PUBLIC_PIX_CITY=${NEXT_PUBLIC_PIX_CITY}
ENV NEXT_PUBLIC_PIX_TRANSACTION_ID=${NEXT_PUBLIC_PIX_TRANSACTION_ID}
